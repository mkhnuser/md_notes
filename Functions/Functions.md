...
Consider a semicircle, parabola, or a line, for example.
...
It's important to separate function definition from a function invocation.
For example, f(2x) might represent a function definition in one context;
and f(2x) might represent an argument 2x passed to the function in another context.

## Big Oh Notation

"How to prove it", Section 5.1, Exercises contain Big Oh Notation usage.
