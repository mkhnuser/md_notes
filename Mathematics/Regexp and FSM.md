...
## Invariants on FSM states

Given an FSM, one might show that a predicate `P(n)` is an invariant on state.
https://youtu.be/gVdrFsnOo_s?si=rYJ6StW95te5fEdm&t=1907
